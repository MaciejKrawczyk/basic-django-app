...
class ExchangeRateHistory(models.Model):
    currency_pair_history = models.ForeignKey(ExchangeRate, on_delete=models.CASCADE,
                                              related_name='currency_pair_history')
    ...
    def __str__(self):
        return f'{self.currency_pair_history} on {self.date}'
